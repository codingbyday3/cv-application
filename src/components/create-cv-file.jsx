export default function CreateCv({userInformations}){
    ...
    if(userInformations.name){
        [firstName, lastName] = userInformations.name.split(" ")
    }
        ...
        <article>
            <section className="cv-side-container">
                ...
                <div className="education">
                    <h4>EDUCATION</h4>
                    <div>
                        <p>{userInformations.school}</p>
                        <p>{userInformations.title}</p>
                        <p>{userInformations.studyDate}</p>
                    </div>
            ...
            <section className="cv-main">
                <div className="user-heading">
                    ...
                    <p>{userInformations.position}</p>
                </div>
                <div className="cv-content">
                    <h4>WORK EXPERIENCE</h4>

                    <div>
                        <p className="previous-company">{userInformations.company}</p>
                    </div>
                    <p className="previous-company-description">
                        {
                            userInformations.responsibilities
                        }
                    </p>
                    <div>
                        <p>From: {userInformations.fromDate}</p>
                        <p>To: {userInformations.toDate}</p>
                    </div>
